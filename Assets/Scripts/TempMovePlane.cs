...
public class TempMovePlane : MonoBehaviour
{
    //Distance variables:
    ...
    //Position variables:
    [SerializeField] private float previousMarkerXPos;
    [SerializeField] private float previousMarkerYPos;
    [SerializeField] private float thisMarkerXPos;
    [SerializeField] private float thisMarkerYPos;
