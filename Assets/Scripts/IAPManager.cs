...
public class IAPManager : MonoBehaviour, IStoreListener
{
    ...
    public static string productPurchaseGame = "fullgamepurchase";
    ...
    public void InitializePurchasing() 
    {
        ...
        builder.AddProduct(productPurchaseGame, ProductType.NonConsumable);
    ...
    {
        BuyProductID(productPurchaseGame);
    }
